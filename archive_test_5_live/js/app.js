...
var PROFILES = {
  source: {
    ...
    lead: "Avant de réagir, vous cherchez le passage original, le contexte et la chronologie. L’emballement vous intéresse moins que les faits disponibles.",
    force: "Résistance aux résumés tronqués et aux extraits sortis de leur contexte.",
    watch: "Chercher un dossier parfaitement complet peut parfois retarder une conclusion déjà bien étayée."
  },
  lexique: {
    title: "L’Analyste des mots",
    lead: "« Toute la France », « choqué », « tout le monde » : vous repérez d’abord l’amplification. Le choix des mots ne passe pas inaperçu.",
  ...
  tempo: {
    title: "L’Observateur patient",
    lead: "Vous savez que l’intensité du moment ne dit pas tout de l’événement. Vous laissez retomber l’agitation avant de vous prononcer.",
  ...
  filtre: {
    title: "Le Lecteur pragmatique",
    lead: "Vous cherchez d’abord les conséquences concrètes. Si rien ne change dans votre quotidien, le sujet perd rapidement sa priorité.",
    ...
    fetch("send.php", {
      ...
      .then(function (out) {
        if (out.ok && out.json && out.json.ok) {
          leadStatus.textContent = "Votre synthèse a été envoyée. Pensez à vérifier votre dossier de courriers indésirables.";
      ...
      .catch(function () {
        ...
        leadStatus.textContent = "L’envoi n’a pas abouti. Vérifiez votre connexion HTTPS et réessayez.";
      });
  });
}
